"""Closed source/release guards for the seven observational quality metrics."""
import importlib.util
from pathlib import Path

ROOT = Path(__file__).resolve().parents[1]
spec = importlib.util.spec_from_file_location(
    'forecast_quality_migration', ROOT / 'scripts/migrate-forecast-quality-items.py')
...
def test_live_adapter_is_released_after_isolated_qualification():
