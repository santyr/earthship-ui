...
if __name__ == '__main__':
    qualifier.main(items={'Predicted_PV_Today_kWh': '3.5',
                          'Predicted_SoC_Trough_Tomorrow': '59.0'},
                   source_path=ROOT / 'openhab/file-config/items/forecast-energy.items',
                   types={'Predicted_PV_Today_kWh': 'Number',
                          'Predicted_SoC_Trough_Tomorrow': 'Number'})
